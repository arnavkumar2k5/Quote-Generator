...
function App() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gray-100 p-4">
      <h1 className="text-2xl mb-20 md:text-7xl font-bold text-gray-800 text-center border-4 border-black p-5">React Quote Generator</h1>
      <div className="w-full max-w-lg mt-4 bg-white shadow-lg rounded-lg p-8 text-center">
        {loading ? (
